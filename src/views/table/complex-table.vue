<template>
    <div class="className">
        <el-card class="anoCard">
            ...
            <div class="searchDiv">
                <el-input type="text" placeholder="请输入订单号" class="width1" v-model="sch_order"></el-input>
            ...
            <el-table :data="tableData" border stripe>
                ...
                <el-table-column prop="address" label="配送地址" width="210"></el-table-column>
                <el-table-column prop="phone" label="联系电话"></el-table-column>
                <el-table-column prop="name" label="配送员" width="70"></el-table-column>
    ...
    methods: {
        ...
        searchTab() {
            ...
            for (let item of this.allList) {
                if (this.sch_order.trim() === '' && this.sch_status === null && this.sch_date === null) {
            ...
            this.$refs[form].validate((valid) => {
                if (valid) {
                    if (type === 'update') {
                        // 改变整个表格数据
                        let start = (this.currentPage - 1) * this.pageSize
                        this.allList[start + this.rowIndex] = Object.assign({}, this.formData)
                        // 解决数组不能通过索引响应数据变化
                        this.$set(this.tableData, this.rowIndex, Object.assign({}, this.formData))
                        this.$notify({
                            title: '成功',
                            message: '订单已修改成功',
                            type: 'success',
