<template>
    <div class="iconsDiv">
        <el-card>
            <p class="driver_p0"><i class="el-icon-s-opportunity"></i>可以使用的图标</p>
            <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-picture-outline-round"></i> Element icons</span>
                    <p class="pTitle">
                        直接通过设置类名为
                        <code>el-icon-iconName</code> 来使用即可，例如：<code>{{ expText1 }}</code>
                    </p>
                ...
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-s-promotion"></i> 阿里iconfonts</span>
                    <p class="pTitle">
                        这里是通过使用阿里iconfont在项目中生成字体图标，直接通过设置类名为
                        <code>el-icon-iconName iconfont</code> 来使用即可，例如：<code>{{ expText2 }}</code
